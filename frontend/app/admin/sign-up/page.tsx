    ...
    return (
      <main className="flex min-h-screen items-center justify-center bg-stone-50 px-4">
        <div className="w-full max-w-sm rounded-2xl border border-stone-200 bg-white p-8 shadow-sm text-center">
          ...
          <Link href="/admin/sign-in" className="mt-4 inline-block font-medium text-amber-600 hover:underline">
            Back to sign in
          </Link>
        </div>
      </main>
    ...
    <main className="flex min-h-screen items-center justify-center bg-stone-50 px-4">
      <div className="w-full max-w-sm rounded-2xl border border-stone-200 bg-white p-8 shadow-sm">
        ...
        <p className="mt-4 text-center text-sm text-stone-600">
          ...
          <Link href="/admin/sign-in" className="font-medium text-amber-600 hover:underline">
            Sign in
          </Link>
        </p>
      </div>
